...
function deliver_setup() {
    ...
    register_nav_menus( array(
        'Footer-links' => esc_html__( 'Footer links', 'business' ),
    ) );
...
function wp_add_google_fonts() {
    ...
    wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css?family=Pacifico', false );
}
